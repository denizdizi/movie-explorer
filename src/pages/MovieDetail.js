              ...
              <Col xs={6} sm={8} md={9} lg={9}>
                <Card className="h-100">
                  <Card.Body>
                    ...
                    <Rating
                        initialRating={selectedMovie.imdbRating / 2}
                        readonly
                        emptySymbol={<FontAwesomeIcon icon={regularStar} className="text-warning fa-2x" />}
                        fullSymbol={<FontAwesomeIcon icon={solidStar} className="text-warning fa-2x" />}
                      />
                      <span className="ms-2">
