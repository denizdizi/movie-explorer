...
import { setFormData, setPage } from "../store/actions"; // Redux store'dan formData'yı güncellemek için kullanıyoruz
      ...
      <form onSubmit={handleSubmit}>
        <div className="row g-2">
          ...
          <div className="col-auto">
            <button type="submit" className="btn btn-primary search-btn" disabled={isSubmitDisabled}>Gönder</button>
          </div>
        </div>
      </form>
    </div>
