...
import { setFormData } from "../store/actions"; // Redux store'dan formData'yı güncellemek için kullanıyoruz
...
const SearchBar = () => {
  ...
  const formData = useSelector((state) => state.state); // Redux store'dan formData'yı alıyoruz
